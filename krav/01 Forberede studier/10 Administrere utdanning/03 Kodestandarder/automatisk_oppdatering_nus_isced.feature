...
Egenskap: Automatisk oppdatering av nus- og isced-koder
  ...
  Regel: Varsling skal være målrettet basert på type endring
    ...
    Scenario: Varsle systemadministratorer om ISCED-mapping endringer i FS Admin
      ...
      Og varselet skal kunne kvitteres ut av systemadministrator
  ...
  Scenario: Komplett integrasjonsflyt med alle komponenter
    ...
    Så skal følgende skje i rekkefølge:
      ...
      | 03:03  | Varslingstjeneste      | Send 5 e-poster til studieplanleggere       | OK       |
      | 03:03  | Varslingstjeneste      | Opprett varsel i FS Admin for sysadmin      | OK       |
    ...
    Og integrasjonsrapporten skal være tilgjengelig i FS Admin systemadministrator-dashboardet
    Og eventuelle varsler skal vises øverst i dashboardet med antall uleste