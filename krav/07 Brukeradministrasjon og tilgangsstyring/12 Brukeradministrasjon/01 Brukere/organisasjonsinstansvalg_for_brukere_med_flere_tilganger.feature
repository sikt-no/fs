# language: no
@TIL-BRU-BRU-002 @tilgangsstyring @organisasjonsinstansvalg
Egenskap: Organisasjonsinstansvalg for brukere med flere tilganger
  ...
  Bakgrunn:
    ...
    Og at brukerflaten sender organisasjonskode for å få tilgang
  ...
  Scenario: Sende riktig organisasjonskode til FS-SIS
    Gitt at jeg har valgt en spesifikk organisasjon
    Når FS Admin henter data fra FS-SIS
    Så skal systemet sende organisasjonskode for den valgte organisasjonen
