...
/**
 * Leser alle .feature- og .md-filer under krav/, parser dem og eksponerer dem som
 * `virtual:krav`. I dev-server pushes endringer som `krav:update`-hendelser over websocket.
