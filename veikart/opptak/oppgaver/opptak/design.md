...
| **Søknadsnummerserie** | Ikke modellert i fs-plattform/opptak. I FS er dette `REGNR_FRA` / `REGNR_TIL`. |
| **Maks søknadsalternativer** | Ikke modellert i fs-plattform/opptak. I FS er dette `TALL_MAKS_STUDIEONSKER`. |
