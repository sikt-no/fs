...
**Dekker krav:** `Tilgjengelige organisasjoner i filter` (listevisning) — `listevisning_og_sok.feature`, endret-bullet i [`spec-changes-2026-06-16-b0e8de5.md`](../spec/spec-changes-2026-06-16-b0e8de5.md) § Endret.
...
**Status**: Completed — se [`task-1-completion.md`](task-1-completion.md).
**Priority**: High
**Size**: M
**Dependencies**: None
...
**Status**: Completed — se [`task-2-completion.md`](task-2-completion.md).
**Priority**: High
**Size**: S
**Dependencies**: Task #1
...
**Status**: Completed — se [`task-3-completion.md`](task-3-completion.md).
**Priority**: High
**Size**: S
**Dependencies**: Task #2
...
**Status**: Completed — se [`task-4-completion.md`](task-4-completion.md). Variant (b) valgt (egen `useGetApplikasjonTilgangerFilterOptions`-hook).
**Priority**: High
**Size**: M
**Dependencies**: Task #1
...
**Status**: Completed — se [`task-5-completion.md`](task-5-completion.md). Static review bekrefter at `usePersonaOverride` dekker alle nye queries; manuell verifikasjons-prosedyre dokumentert for QA.
**Priority**: Medium
**Size**: S
...
**Status**: Completed — se [`task-6-completion.md`](task-6-completion.md). Issue-body utkast skrevet til [`task-6-handoff-issue-draft.md`](task-6-handoff-issue-draft.md); selve `gh issue create`-handlingen er overlatt til brukeren (krever target-repo-valg og autorisasjon).
**Priority**: Medium
**Size**: S
